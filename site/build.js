...
async function buildStaticSite() {
    ...
    try {
        ...
        const rootFiles = ['404.html', 'robots.txt', 'sitemap.xml', 'CNAME', '29c6507763d2303d801cc8ed89d39f88.txt', 'BingSiteAuth.xml', '621a69ca2bd75c0778c9658dc1a62f0a.txt'];
        ...
        console.log('📄 Markdown: 5-TEP-GTE-v{version}-{codename}.md (in root)');
